...
import ClientSearchInput from '../../atoms/SearchInput';
...
function Footer(props: any) {
    return (
        <div>
            ...
            <Container className={props.classes.infoPanel}>
                <Grid container>
                    <Grid lg={3} md={12} xs={12} item>
                        {
                            Support.map((value, index) => {
                                if (index === 0)
                                    return <p className={props.classes.titleInfo} key={index}>{value}</p>
                                else
